document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderLots(lots) {
    ...
    lotsContainer.innerHTML = currentLots.map((lot, index) => `
      <div class="border border-black bg-white rounded-[28px] overflow-hidden transition hover:shadow-lg min-w-[92%] md:min-w-0 snap-start shrink-0 md:shrink lot-card-animate">
        <div class="p-5">
